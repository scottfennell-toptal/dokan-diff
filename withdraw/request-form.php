    ...
    <div class="dokan-form-group">
        ...
        <div class="dokan-w5 dokan-text-left">
            <div class="dokan-input-group">
                ...
                <input name="witdraw_amount" required number min="<?php echo esc_attr( dokan_get_option( 'withdraw_limit', 'dokan_withdraw', 0 ) ); ?>" class="form-control" id="withdraw-amount" name="price" type="number" placeholder="0.00" value="<?php echo $amount; ?>"  >
            </div>
        </div>
    </div>
