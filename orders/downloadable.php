...
<div class="order_download_permissions wc-metaboxes-wrapper">
    ...
    <div class="toolbar dokan-clearfix">
        ...
        <div class="dokan-w7" style="margin-right: 5px;">
            <select name="grant_access_id" class="grant_access_id dokan-select2 form-control" data-placeholder="<?php _e( 'Choose a downloadable product&hellip;', 'dokan-lite' ) ?>" multiple="multiple">
                <?php
