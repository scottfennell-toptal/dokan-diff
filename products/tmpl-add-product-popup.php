            ...
            <div class="product-form-container">
                ...
                <div class="content-half-part dokan-product-field-content">
                    <div class="dokan-form-group">
                        <input type="text" class="form-control" name="post_title" placeholder="<?php _e( 'Theme name', 'dokan-lite' ); ?>">
                    </div>
                        ...
                        <div class="dokan-form-group dokan-clearfix dokan-price-container">
                            <div class="content-half-part">
                                ...
                                <div class="dokan-input-group">
                                    ...
                                    <input type="number" class="form-control" name="_regular_price" placeholder="0.00" min="0" step="any">
                                </div>
                            </div>
                            ...
                            <div class="content-half-part sale-price">
                                ...
                                <div class="dokan-input-group">
                                    <span class="dokan-input-group-addon"><?php echo get_woocommerce_currency_symbol(); ?></span>
                                    <input type="number" class="form-control" name="_sale_price" placeholder="0.00" min="0" step="any">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="dokan-hide sale-schedule-container sale_price_dates_fields dokan-clearfix dokan-form-group">
                            <div class="content-half-part from">
                                <div class="dokan-input-group">
                                    ...
                                    <input type="text" name="_sale_price_dates_from" class="form-control datepicker sale_price_dates_from" value="" maxlength="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" placeholder="<?php _e( 'YYYY-MM-DD', 'dokan-lite' ); ?>">
                                </div>
                            </div>
                            ...
                            <div class="content-half-part to">
                                <div class="dokan-input-group">
                                    ...
                                    <input type="text" name="_sale_price_dates_to" class="form-control datepicker sale_price_dates_to" value="" maxlength="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" placeholder="<?php _e( 'YYYY-MM-DD', 'dokan-lite' ); ?>">
                                </div>
                            </div>
                ...
                <div class="product-full-container">
                    ...
                    <div class="dokan-form-group">
                        ...
                        $drop_down_tags = wp_dropdown_categories( array(
                            ...
                            'title_li'         => '',
                            'class'            => 'product_tags form-control dokan-select2',
                            'exclude'          => '',
                            'selected'         => array(),
                            'echo'             => 0,
                            'walker'           => new DokanTaxonomyWalker()
                    ...
                    <div class="dokan-form-group">
                        <textarea name="post_excerpt" id="" class="form-control" rows="5" placeholder="<?php _e( 'Enter some short description about this product...' , 'dokan-lite' ) ?>"></textarea>
                    </div>
                </div>
            </div>
