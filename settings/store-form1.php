    ...
    <div class="row mt-5" style="text-align:left;">
        <div class="col-lg-6 mb-3 mb-md-0">
            <div class="form-group">
                ...
                <span class="form-sublink" id="dokan_store_name_count">0/40</span>
            ...
            <div class="form-group">
                <label for="InputStoreBio">Store bio</label><span class="form-sublink">0/120</span>
                <textarea class="form-control" id="InputStoreBio" name="" cols="" rows=""></textarea>
            </div>
            <div class="form-group mb-4">
                <label for="InputSupportLink">Support link</label><small class="form-text" id="emailSupport">Where customers will contact you for support. Can be a link to a support site (i.e. https://themes.zendesk.com/hc/en-us) or a support email address mailto link (i.e. mailto:themes@getbootstrap.com).</small>
                <input class="form-control" id="InputSupportLink" type="text" aria-describedby="emailSupport" placeholder="">
            </div>

            <button class="btn btn-brand btn-block" type="submit">Save changes</button>
        </div>
        <div class="col-lg-6 d-none d-lg-block">
            <div class="form-group">
                ...
                <div class="upload-image">
                    <div class="upload-image__item upload-image__cover-holder upload-image-placeholder" style="background-image:url('/assets/images/temp/uploaded-cover.png');">
                        <div class="upload-image__cover__overlay dokan-banner">
                            ...
                            <div>
                                <a href="#" class="btn btn-brand btn-sm btn-file d-none d-md-block dokan-banner-drag  dokan-theme"><?php _e('Swap Cover', 'dokan-lite'); ?></a>
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-3 mb-md-0">
                            ...
                            <div class="upload-image__avatar-inner">
                                <div class="dokan-w5 dokan-gravatar">
                                    ...
                                    <div class="gravatar-button-area<?php echo $gravatar ? ' dokan-hide' : ''; ?> upload-image__avatar upload-image-placeholder" style="background-image:url('/assets/images/temp/profile-avatar.png');">
                                        <a href="#" class="dokan-pro-gravatar-drag dokan-btn dokan-btn-default"><?php _e('Upload Photo', 'dokan-lite'); ?></a>
                            ...
                            <div class="upload-image__description">
                                <h4>Company name</h4>
                                <p class="d-none d-md-block">This is the company bio and will be reflected once you enter something for your bio.</p>
                            </div>
                        </div>
                        <p class="d-md-none">This is the company bio and will be reflected once you enter something for your bio.</p>
                        <div class="d-flex justify-content-between align-items-center mt-3 d-md-none">
                            <span class="btn btn-brand btn-sm btn-file btn-block">
                                Swap avatar 
                                <input type="file">
                            </span>
                            <span class="btn btn-brand btn-sm btn-block btn-file ml-3">
                                Swap cover 
                                <input type="file">
                            </span>
                        </div>
